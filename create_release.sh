...
(on: release: created), which builds the VRO plugin and attaches the
o11nplugin-vro-<version>.dar and o11nplugin-vro-core-<version>-javadoc.jar
...
Arguments:
  --test         Test mode: creates the release as a draft (--draft) and skips
                 ...
                 testing of the tag + release creation flow.
  --previous-tag <tag>
