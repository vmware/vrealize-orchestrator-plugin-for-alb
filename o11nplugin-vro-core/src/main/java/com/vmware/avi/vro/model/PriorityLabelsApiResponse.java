...
import com.vmware.avi.vro.model.PriorityLabels;
...
@VsoObject(create = false, name = "PriorityLabelsApiResponse")
@VsoFinder(name = Constants.FINDER_VRO_PRIORITYLABELSAPIRESPONSE, idAccessor = "getObjectID()")
@Service
public class PriorityLabelsApiResponse extends AviRestResource  {
  @JsonProperty("count")
  ...
  **/
  ...
  public String getObjectID() {
		return "PriorityLabelsApiResponse";
  }
