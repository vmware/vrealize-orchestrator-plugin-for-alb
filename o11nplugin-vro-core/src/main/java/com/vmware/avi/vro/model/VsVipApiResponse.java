...
@VsoObject(create = false, name = "VsVipApiResponse")
@VsoFinder(name = Constants.FINDER_VRO_VSVIPAPIRESPONSE, idAccessor = "getObjectID()")
@Service
public class VsVipApiResponse extends AviRestResource  {
  @JsonProperty("count")
