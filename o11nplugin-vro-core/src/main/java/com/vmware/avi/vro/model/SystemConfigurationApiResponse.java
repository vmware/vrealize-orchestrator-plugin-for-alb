...
import com.vmware.avi.vro.model.SystemConfiguration;
...
@VsoObject(create = false, name = "SystemConfigurationApiResponse")
@VsoFinder(name = Constants.FINDER_VRO_SYSTEMCONFIGURATIONAPIRESPONSE, idAccessor = "getObjectID()")
@Service
public class SystemConfigurationApiResponse extends AviRestResource  {
  @JsonProperty("count")
  ...
  **/
  ...
  public String getObjectID() {
		return "SystemConfigurationApiResponse";
  }
