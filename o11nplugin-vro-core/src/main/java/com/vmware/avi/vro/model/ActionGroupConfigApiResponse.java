...
import com.vmware.avi.vro.model.ActionGroupConfig;
...
@VsoObject(create = false, name = "ActionGroupConfigApiResponse")
@VsoFinder(name = Constants.FINDER_VRO_ACTIONGROUPCONFIGAPIRESPONSE, idAccessor = "getObjectID()")
@Service
public class ActionGroupConfigApiResponse extends AviRestResource  {
  @JsonProperty("count")
  ...
  **/
  ...
  public String getObjectID() {
		return "ActionGroupConfigApiResponse";
  }
