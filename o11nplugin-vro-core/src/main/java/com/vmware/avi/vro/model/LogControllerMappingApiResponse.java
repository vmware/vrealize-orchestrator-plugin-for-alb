...
import com.vmware.avi.vro.model.LogControllerMapping;
...
@VsoObject(create = false, name = "LogControllerMappingApiResponse")
@VsoFinder(name = Constants.FINDER_VRO_LOGCONTROLLERMAPPINGAPIRESPONSE, idAccessor = "getObjectID()")
@Service
public class LogControllerMappingApiResponse extends AviRestResource  {
  @JsonProperty("count")
  ...
  **/
  ...
  public String getObjectID() {
		return "LogControllerMappingApiResponse";
  }
