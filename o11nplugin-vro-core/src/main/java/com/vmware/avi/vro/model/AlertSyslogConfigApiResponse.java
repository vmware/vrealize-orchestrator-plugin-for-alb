...
import com.vmware.avi.vro.model.AlertSyslogConfig;
...
@VsoObject(create = false, name = "AlertSyslogConfigApiResponse")
@VsoFinder(name = Constants.FINDER_VRO_ALERTSYSLOGCONFIGAPIRESPONSE, idAccessor = "getObjectID()")
@Service
public class AlertSyslogConfigApiResponse extends AviRestResource  {
  @JsonProperty("count")
  ...
  **/
  ...
  public String getObjectID() {
		return "AlertSyslogConfigApiResponse";
  }
