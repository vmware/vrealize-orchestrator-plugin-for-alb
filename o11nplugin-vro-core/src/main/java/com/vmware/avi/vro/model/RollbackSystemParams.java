 ...
 *
 */
@VsoObject(create = false, name = "RollbackSystemParams")
@VsoFinder(name = Constants.FINDER_VRO_ROLLBACKSYSTEMPARAMS, idAccessor = "getObjectID()")
@JsonIgnoreProperties(ignoreUnknown = true)
@Service
public class RollbackSystemParams extends AviRestResource {
...
public boolean equals(java.lang.Object o) {
  ...
  Objects.equals(this.prechecksOnly, objRollbackSystemParams.prechecksOnly);
}
