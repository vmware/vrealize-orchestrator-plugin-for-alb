...
import com.vmware.avi.vro.model.AutoScaleLaunchConfig;
...
@VsoObject(create = false, name = "AutoScaleLaunchConfigApiResponse")
@VsoFinder(name = Constants.FINDER_VRO_AUTOSCALELAUNCHCONFIGAPIRESPONSE, idAccessor = "getObjectID()")
@Service
public class AutoScaleLaunchConfigApiResponse extends AviRestResource  {
  @JsonProperty("count")
  ...
  **/
  ...
  public String getObjectID() {
		return "AutoScaleLaunchConfigApiResponse";
  }
