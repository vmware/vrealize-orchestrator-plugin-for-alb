 ...
 *
 */
@VsoObject(create = false, name = "VsScaleOutEventDetails")
@VsoFinder(name = Constants.FINDER_VRO_VSSCALEOUTEVENTDETAILS)
@JsonIgnoreProperties(ignoreUnknown = true)
@Service
public class VsScaleOutEventDetails extends AviRestResource {
