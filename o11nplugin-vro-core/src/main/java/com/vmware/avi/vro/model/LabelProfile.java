...
/**
 * The LabelProfile is a POJO class extends AviRestResource that used for creating
 * LabelProfile.
 *
 * @version 1.0
 * @since 
 *
 */
@VsoObject(create = false, name = "LabelProfile")
@VsoFinder(name = Constants.FINDER_VRO_LABELPROFILE, idAccessor = "getObjectID()")
@JsonIgnoreProperties(ignoreUnknown = true)
@Service
public class LabelProfile extends AviRestResource {
   ...
   */
  @VsoMethod
  public List<Label> getLabelDefinitions() {
    return labelDefinitions;
  }
   ...
   */
  @VsoMethod
  public void setLabelDefinitions(List<Label>  labelDefinitions) {
   ...
   */
  @VsoMethod
  public LabelProfile addLabelDefinitionsItem(Label labelDefinitionsItem) {
    if (this.labelDefinitions == null) {
      this.labelDefinitions = new ArrayList<Label>();
    }
...
public boolean equals(java.lang.Object o) {
  ...
  LabelProfile objLabelProfile = (LabelProfile) o;
  return   Objects.equals(this.uuid, objLabelProfile.uuid)&&
