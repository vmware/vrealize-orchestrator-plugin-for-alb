...
import com.vmware.avi.vro.model.VIMgrSEVMRuntime;
...
@VsoObject(create = false, name = "VIMgrSEVMRuntimeApiResponse")
@VsoFinder(name = Constants.FINDER_VRO_VIMGRSEVMRUNTIMEAPIRESPONSE, idAccessor = "getObjectID()")
@Service
public class VIMgrSEVMRuntimeApiResponse extends AviRestResource  {
  @JsonProperty("count")
  ...
  **/
  ...
  public String getObjectID() {
		return "VIMgrSEVMRuntimeApiResponse";
  }
