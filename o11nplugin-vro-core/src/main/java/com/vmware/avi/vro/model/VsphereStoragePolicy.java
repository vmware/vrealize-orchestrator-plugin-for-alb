 ...
 *
 */
@VsoObject(create = false, name = "VsphereStoragePolicy")
@VsoFinder(name = Constants.FINDER_VRO_VSPHERESTORAGEPOLICY)
@JsonIgnoreProperties(ignoreUnknown = true)
@Service
public class VsphereStoragePolicy extends AviRestResource {
