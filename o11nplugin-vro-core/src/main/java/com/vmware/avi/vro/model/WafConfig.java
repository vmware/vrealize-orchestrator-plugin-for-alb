...
import com.vmware.avi.vro.model.JsonParsingLimits;
...
public class WafConfig extends AviRestResource {
    ...
    @JsonProperty("enable_json_parsing_limits")
    @JsonInclude(Include.NON_NULL)
    private Boolean enableJsonParsingLimits = false;

    @JsonProperty("enforce_max_body_size")
    @JsonInclude(Include.NON_NULL)
    private Boolean enforceMaxBodySize = false;

    @JsonProperty("ignore_incomplete_request_body_error")
    @JsonInclude(Include.NON_NULL)
    private Boolean ignoreIncompleteRequestBodyError = true;

    @JsonProperty("json_parsing_limits")
    @JsonInclude(Include.NON_NULL)
    private JsonParsingLimits jsonParsingLimits;

    @JsonProperty("match_element_sub_parsers")
    @JsonInclude(Include.NON_NULL)
    private List<WafMatchElementSubParser> matchElementSubParsers;
    ...
    @JsonProperty("xml_collection")
    @JsonInclude(Include.NON_NULL)
    private String xmlCollection = "WAF_XML_COLLECTION_XML";
   ...
   */
  @VsoMethod
  public Boolean getEnableJsonParsingLimits() {
    return enableJsonParsingLimits;
  }
   ...
   */
  @VsoMethod
  public void setEnableJsonParsingLimits(Boolean  enableJsonParsingLimits) {
    this.enableJsonParsingLimits = enableJsonParsingLimits;
  }
   ...
   */
  @VsoMethod
  public Boolean getEnforceMaxBodySize() {
    return enforceMaxBodySize;
  }
   ...
   */
  @VsoMethod
  public void setEnforceMaxBodySize(Boolean  enforceMaxBodySize) {
    this.enforceMaxBodySize = enforceMaxBodySize;
  }
   ...
   */
  @VsoMethod
  public JsonParsingLimits getJsonParsingLimits() {
    return jsonParsingLimits;
  }
   ...
   */
  @VsoMethod
  public void setJsonParsingLimits(JsonParsingLimits jsonParsingLimits) {
    this.jsonParsingLimits = jsonParsingLimits;
  }
   ...
   */
  @VsoMethod
  public List<WafMatchElementSubParser> getMatchElementSubParsers() {
    return matchElementSubParsers;
  }

  /**
   * This is the setter method. this will set the matchElementSubParsers
   * Every match element listed here will be parsed by a second parser.
   * This happens non-recursivly.
   * Field introduced in 31.2.1.
   * Allowed with any value in enterprise, enterprise with cloud services edition.
   ...
   */
  @VsoMethod
  public void setMatchElementSubParsers(List<WafMatchElementSubParser>  matchElementSubParsers) {
    this.matchElementSubParsers = matchElementSubParsers;
  }
   ...
   */
  @VsoMethod
  public WafConfig addMatchElementSubParsersItem(WafMatchElementSubParser matchElementSubParsersItem) {
    if (this.matchElementSubParsers == null) {
      this.matchElementSubParsers = new ArrayList<WafMatchElementSubParser>();
    }
    this.matchElementSubParsers.add(matchElementSubParsersItem);
    return this;
  }
   ...
   */
  @VsoMethod
  public void setXmlCollection(String  xmlCollection) {
...
public boolean equals(java.lang.Object o) {
  ...
  Objects.equals(this.xmlCollection, objWafConfig.xmlCollection)&&
  Objects.equals(this.enforceMaxBodySize, objWafConfig.enforceMaxBodySize)&&
  Objects.equals(this.enableJsonParsingLimits, objWafConfig.enableJsonParsingLimits)&&
  Objects.equals(this.jsonParsingLimits, objWafConfig.jsonParsingLimits)&&
  Objects.equals(this.matchElementSubParsers, objWafConfig.matchElementSubParsers);
}
...
public String toString() {
  ...
  sb.append("class WafConfig {\n");
      sb.append("    allowedHttpVersions: ").append(toIndentedString(allowedHttpVersions)).append("\n");
        ...
        sb.append("    enableJsonParsingLimits: ").append(toIndentedString(enableJsonParsingLimits)).append("\n");
        ...
        sb.append("    jsonParsingLimits: ").append(toIndentedString(jsonParsingLimits)).append("\n");
        sb.append("    matchElementSubParsers: ").append(toIndentedString(matchElementSubParsers)).append("\n");
