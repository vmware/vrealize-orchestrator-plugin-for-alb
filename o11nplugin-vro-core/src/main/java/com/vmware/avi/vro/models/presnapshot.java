...
/**
 * The presnapshot is a POJO class extends AviRestResource that used for creating
 * presnapshot.
 *
 * @version 1.0
 * @since 
 *
 */
@VsoObject(create = false, name = "presnapshot")
@VsoFinder(name = Constants.FINDER_VRO_PRESNAPSHOT)
@JsonIgnoreProperties(ignoreUnknown = true)
@Service
public class presnapshot extends AviRestResource {
...
public boolean equals(java.lang.Object o) {
  ...
  presnapshot objpresnapshot = (presnapshot) o;
  return   Objects.equals(this.vssnapshot, objpresnapshot.vssnapshot)&&
  Objects.equals(this.sesnapshot, objpresnapshot.sesnapshot)&&
  Objects.equals(this.poolsnapshot, objpresnapshot.poolsnapshot)&&
  Objects.equals(this.gssnapshot, objpresnapshot.gssnapshot);
}

@Override
public String toString() {
  StringBuilder sb = new StringBuilder();
  sb.append("class presnapshot {\n");
