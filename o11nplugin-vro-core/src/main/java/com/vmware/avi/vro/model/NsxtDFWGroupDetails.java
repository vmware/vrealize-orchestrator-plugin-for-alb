 ...
 *
 */
@VsoObject(create = false, name = "NsxtDFWGroupDetails")
@VsoFinder(name = Constants.FINDER_VRO_NSXTDFWGROUPDETAILS)
@JsonIgnoreProperties(ignoreUnknown = true)
@Service
public class NsxtDFWGroupDetails extends AviRestResource {
