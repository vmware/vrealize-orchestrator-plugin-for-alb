...
@VsoFinder(name = "VirtualService", idAccessor = "getObjectID()")
...
public class VirtualService extends AviRestResource {
	 ...
	 * Standby HA mode and Load Distribution among Active Standby is enabled. This
	 * field is used to tag the VirtualService so that VirtualServices with the same
	 * tag will share the same Active ServiceEngine. VirtualServices with different
	 * tags will have different Active ServiceEngines. If one of the ServiceEngine's
	 * in the ServiceEngineGroup fails, all VirtualServices will end up using the
	 * same Active ServiceEngine. Redistribution of the VirtualServices can be
	 * either manual or automated when the failed ServiceEngine recovers.
	 * Redistribution is based on the auto redistribute property of the
	 * ServiceEngineGroup. Enum options - ACTIVE_STANDBY_SE_1, ACTIVE_STANDBY_SE_2.
	 * 
	 ...
	 * monitor. This setting takes effect for future Virtual Service flaps. To
	 * advertise current VSes that are down, please disable and re-enable the
	 * Virtual Service. Field introduced in 20.1.1.
	 * 
	...
	/**
	 * Process request even if invalid client certificate is presented. Datascript
	 * APIs need to be used for processing of such requests. Field introduced in
	 * 18.2.3.
	 * 
	...
	/**
	 * The name of the Contract/Graph associated with the Virtual Service. Should be
	 * in the <Contract name> <Graph name> format. This is applicable only for
	 * Service Integration mode with Cisco APIC Controller . Field introduced in
	 * 17.2.12,18.1.2.
	 * 
	...
	/**
	 * Enable application layer specific features for the Virtual Service. It is a
	 * reference to an object of type ApplicationProfile.
	 * 
	...
	/**
	 * Auto-allocate floating/elastic IP from the Cloud infrastructure. Field
	...
	/**
	 * (internal-use) FIP allocated by Avi in the Cloud infrastructure. Field
	 * deprecated in 17.1.1.
	 * 
	...
	/**
	 * (internal-use) VIP allocated by Avi in the Cloud infrastructure. Field
	 * deprecated in 17.1.1.
	 * 
	...
	/**
	 * (internal-use)Applicable for Azure only. Azure Availability set to which this
	 * VS is associated. Internally set by the cloud connector. Field introduced in
	 * 17.2.12, 18.1.2.
	 * 
	...
	/**
	 * (This is a beta feature). Sync Key-Value cache to the new SEs when VS is
	 * scaled out. For ex SSL sessions are stored using VS's Key-Value cache. When
	 * the VS is scaled out, the SSL session information is synced to the new SE,
	 * allowing existing SSL sessions to be reused on the new SE. . Field introduced
	 * in 17.2.7, 18.1.1.
	 * 
	 ...
	 * CLOUD_VCA, CLOUD_APIC, CLOUD_MESOS, CLOUD_LINUXSERVER, CLOUD_DOCKER_UCP,
	...
	/**
	 * Select the algorithm for QoS fairness. This determines how multiple Virtual
	 * Services sharing the same Service Engines will prioritize traffic over a
	 * congested network.
	 * 
	...
	/**
	 * (internal-use) Discovered networks providing reachability for client facing
	 * Virtual Service IP. This field is deprecated. It is a reference to an object
	 * of type Network. Field deprecated in 17.1.1.
	 * 
	...
	/**
	 * (internal-use) Discovered networks providing reachability for client facing
	 * Virtual Service IP. This field is used internally by Avi, not editable by the
	 * user. Field deprecated in 17.1.1.
	 * 
	...
	/**
	 * (internal-use) Discovered subnets providing reachability for client facing
	 * Virtual Service IP. This field is deprecated. Field deprecated in 17.1.1.
	 * 
	...
	/**
	 * Service discovery specific data including fully qualified domain name, type
	 * and Time-To-Live of the DNS record. Note that only one of fqdn and dns_info
	 * setting is allowed.
	 * 
	 * @return dnsInfo
	 **/
	...
	/**
	 * DNS Policies applied on the dns traffic of the Virtual Service. Field
	...
	/**
	 * Response traffic to clients will be sent back to the source MAC address of
	 * the connection, rather than statically sent to a default gateway.
	 * 
	 * @return enableAutogw
	 **/
	...
	/**
	 * Enable Route Health Injection for Source NAT'ted floating IP Address using
	 * the BGP Config in the vrf context.
	 * 
	 ...
	 * send the custom error page to the client generated by the proxy. It is a
	 * reference to an object of type ErrorPageProfile. Field introduced in 17.2.4.
	 * 
	...
	/**
	 * Floating IP to associate with this Virtual Service. Field deprecated in
	 * 17.1.1.
	 * 
	 * @return floatingIp
	 **/
	 ...
	 * exist, then the subnet for the floating IP address allocation. This field is
	 * applicable only if the VirtualService belongs to an OpenStack or AWS cloud.
	 * In OpenStack or AWS cloud it is required when auto_allocate_floating_ip is
	 * selected. Field deprecated in 17.1.1.
	 * 
	...
	/**
	 * Criteria for flow labelling. Enum options - NO_LABEL, APPLICATION_LABEL,
	 * SERVICE_LABEL.
	 * 
	...
	/**
	 * DNS resolvable, fully qualified domain name of the virtualservice. Only one
	 * of 'fqdn' and 'dns_info' configuration is allowed.
	 * 
	 * @return fqdn
	 **/
	...
	/**
	 * Translate the host name sent to the servers to this value. Translate the host
	 * name sent from servers back to the value used by the client.
	 * 
	...
	/**
	 * Subnet and/or Network for allocating VirtualService IP by IPAM Provider
	 * module. Field deprecated in 17.1.1.
	 * 
	...
	/**
	 * L4 Policies applied to the data traffic of the Virtual Service. Field
	 * introduced in 17.2.7.
	 * 
	 * @return l4Policies
	 **/
	...
	/**
	 * Limit potential DoS attackers who exceed max_cps_per_client significantly to
	 * a fraction of max_cps_per_client for a while.
	 * 
	 * @return limitDoser
	 **/
	...
	/**
	 * Maximum connections per second per client IP. Allowed values are 10-1000.
	...
	/**
	 * Microservice representing the virtual service. It is a reference to an object
	...
	/**
	 * Minimum number of UP pools to mark VS up. Field introduced in 18.2.1,
	 * 17.2.12.
	 * 
	 * @return minPoolsUp
	 **/
	 ...
	 * for the protocol. It is a reference to an object of type NetworkProfile.
	 * 
	...
	/**
	 * Manually override the network on which the Virtual Service is placed. It is a
	 * reference to an object of type Network. Field deprecated in 17.1.1.
	 * 
	 * @return networkRef
	 **/
	...
	/**
	 * Network security policies for the Virtual Service. It is a reference to an
	 * object of type NetworkSecurityPolicy.
	 * 
	...
	/**
	 * A list of NSX Service Groups representing the Clients which can access the
	 * Virtual IP of the Virtual Service. Field introduced in 17.1.1.
	 * 
	...
	/**
	 * Optional settings that determine performance limits like max connections or
	 * bandwdith etc.
	 * 
	...
	/**
	 * The pool group is an object that contains pools. It is a reference to an
	 * object of type PoolGroup.
	 * 
	 * @return poolGroupRef
	 **/
	 ...
	 * attributes such as load-balancing and persistence. It is a reference to an
	 * object of type Pool.
	 * 
	 * @return poolRef
	 **/
	...
	/**
	 * (internal-use) Network port assigned to the Virtual Service IP address. Field
	 * deprecated in 17.1.1.
	 * 
	 * @return portUuid
	 **/
	...
	/**
	 * Disable re-distribution of flows across service engines for a virtual
	 * service. Enable if the network itself performs flow hashing with ECMP in
	 * environments such as GCP.
	 * 
	 * @return scaleoutEcmp
	 **/
	...
	/**
	 * The Service Engine Group to use for this Virtual Service. Moving to a new SE
	 * Group is disruptive to existing connections for this VS. It is a reference to
	 * an object of type ServiceEngineGroup.
	 * 
	 * @return seGroupRef
	 **/
	...
	/**
	 * Security policy applied on the traffic of the Virtual Service. This policy is
	 * used to perform security actions such as Distributed Denial of Service (DDoS)
	 * attack mitigation, etc. It is a reference to an object of type
	 * SecurityPolicy. Field introduced in 18.2.1.
	 * 
	 ...
	 * connections. Leave blank to use the same settings as the client to VS side of
	 * the connection. It is a reference to an object of type NetworkProfile.
	 * 
	...
	/**
	 * Metadata pertaining to the Service provided by this virtual service. In
	 * Openshift/Kubernetes environments, egress pod info is stored. Any user input
	...
	/**
	 * Sideband configuration to be used for this virtualservice.It can be used for
	 * sending traffic to sideband VIPs for external inspection etc.
	 * 
	...
	/**
	 * GSLB pools used to manage site-persistence functionality. Each
	 * site-persistence pool contains the virtualservices in all the other sites,
	 * that is auto-generated by the GSLB manager. This is a read-only field for the
	 * user. It is a reference to an object of type Pool. Field introduced in
	 * 17.2.2.
	 * 
	 * @return spPoolRefs
	 **/
	...
	/**
	 * Select or create one or two certificates, EC and/or RSA, that will be
	 * presented to SSL/TLS terminated connections. It is a reference to an object
	 * of type SSLKeyAndCertificate.
	 * 
	...
	/**
	 * Determines the set of SSL versions and ciphers to accept for SSL/TLS
	 * terminated connections. It is a reference to an object of type SSLProfile.
	 * 
	...
	/**
	 * Select SSL Profile based on client IP address match. Field introduced in
	 * 18.2.3.
	 * 
	...
	/**
	 * Expected number of SSL session cache entries (may be exceeded). Allowed
	 * values are 1024-16383.
	 * 
	...
	/**
	 * Client Authentication and Authorization Policy for the virtualservice. Field
	 * deprecated in 18.2.3. Field introduced in 18.2.1.
	 * 
	 * @return ssoPolicy
	 **/
	...
	/**
	 * The SSO Policy attached to the virtualservice. It is a reference to an object
	 * of type SSOPolicy. Field introduced in 18.2.3.
	 * 
	 * @return ssoPolicyRef
	 **/
	...
	/**
	 * List of static DNS records applied to this Virtual Service. These are static
	 * entries and no health monitoring is performed against the IP addresses.
	 * 
	...
	/**
	 * Subnet providing reachability for client facing Virtual Service IP. Field
	 * deprecated in 17.1.1.
	 * 
	 * @return subnet
	 **/
	...
	/**
	 * It represents subnet for the Virtual Service IP address allocation when
	 * auto_allocate_ip is True.It is only applicable in OpenStack or AWS cloud.
	 * This field is required if auto_allocate_ip is True. Field deprecated in
	 * 17.1.1.
	 * 
	 * @return subnetUuid
	 **/
	...
	/**
	 * Used for testing SE Datastore Upgrade 2.0 functionality. It is a reference to
	 * an object of type TestSeDatastoreLevel1. Field introduced in 18.2.6.
	 * 
	...
	/**
	 * Topology Policies applied on the dns traffic of the Virtual Service based
	 * onGSLB Topology algorithm. Field introduced in 18.2.3.
	 * 
	...
	/**
	 * Server network or list of servers for cloning traffic. It is a reference to
	 * an object of type TrafficCloneProfile. Field introduced in 17.1.1.
	 * 
	 ...
	 * This setting is effective only when the enabled flag is set to True. Field
	...
	/**
	 * Specify if this is a normal Virtual Service, or if it is the parent or child
	 * of an SNI-enabled virtual hosted Virtual Service. Enum options -
	...
	/**
	 * Use the Virtual IP as the SNAT IP for health monitoring and sending traffic
	 * to the backend servers instead of the Service Engine interface IP. The caveat
	 * of enabling this option is that the VirtualService cannot be configued in an
	 * Active-Active HA mode. DNS based Multi VIP solution has to be used for HA &
	 * Non-disruptive Upgrade purposes. Field introduced in 17.1.9,17.2.3.
	 * 
	 * @return useVipAsSnat
	 **/
	 ...
	 * field. If this is a match, the parent VS will forward the connection to this
	 * child VS.
	 * 
	 * @return vhDomainName
	 **/
	...
	/**
	 * List of Virtual Service IPs. While creating a 'Shared VS',please use
	 * vsvip_ref to point to the shared entities. Field introduced in 17.1.1.
	 * 
	 * @return vip
	 **/
	...
	/**
	 * Virtual Routing Context that the Virtual Service is bound to. This is used to
	 * provide the isolation of the set of networks the application is attached to.
	...
	/**
	 * Checksum of cloud configuration for VsVip. Internally set by cloud connector.
	...
	/**
	 * Mostly used during the creation of Shared VS, this field refers to entities
	 * that can be shared across Virtual Services. It is a reference to an object of
	 * type VsVip. Field introduced in 17.1.1.
	 * 
	 * @return vsvipRef
	 **/
	...
	/**
	 * WAF policy for the Virtual Service. It is a reference to an object of type
	 * WafPolicy. Field introduced in 17.2.1.
	 * 
	 * @return wafPolicyRef
	 **/
	...
	/**
	 * The Quality of Service weight to assign to traffic transmitted from this
	 * Virtual Service. A higher weight will prioritize traffic versus other Virtual
	 * Services sharing the same Service Engines. Allowed values are 1-128.
	 * 
	 * @return weight
	 **/
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.lastModified, virtualService.lastModified)
				...
				&& Objects.equals(this.type, virtualService.type) && Objects.equals(this.url, virtualService.url)
	...
	public int hashCode() {
		return Objects.hash(lastModified, activeStandbySeTag, advertiseDownVs, allowInvalidClientCert, analyticsPolicy,
				analyticsProfileRef, apicContractGraph, applicationProfileRef, autoAllocateFloatingIp, autoAllocateIp,
				availabilityZone, aviAllocatedFip, aviAllocatedVip, azureAvailabilitySet, bulkSyncKvcache, clientAuth,
				closeClientConnOnConfigUpdate, cloudConfigCksum, cloudRef, cloudType, connectionsRateLimit,
				contentRewrite, createdBy, delayFairness, description, discoveredNetworkRef, discoveredNetworks,
				discoveredSubnet, dnsInfo, dnsPolicies, eastWestPlacement, enableAutogw, enableRhi, enableRhiSnat,
				enabled, errorPageProfileRef, floatingIp, floatingSubnetUuid, flowDist, flowLabelType, fqdn,
				hostNameXlate, httpPolicies, ignPoolNetReach, ipAddress, ipamNetworkSubnet, l4Policies, limitDoser,
				maxCpsPerClient, microserviceRef, minPoolsUp, name, networkProfileRef, networkRef,
				networkSecurityPolicyRef, nsxSecuritygroup, performanceLimits, poolGroupRef, poolRef, portUuid,
				removeListeningPortOnVsDown, requestsRateLimit, samlSpConfig, scaleoutEcmp, seGroupRef,
				securityPolicyRef, serverNetworkProfileRef, serviceMetadata, servicePoolSelect, services,
				sidebandProfile, snatIp, spPoolRefs, sslKeyAndCertificateRefs, sslProfileRef, sslProfileSelectors,
				sslSessCacheAvgSize, ssoPolicy, ssoPolicyRef, staticDnsRecords, subnet, subnetUuid, tenantRef,
				testSeDatastoreLevel1Ref, topologyPolicies, trafficCloneProfileRef, trafficEnabled, type, url,
				useBridgeIpAsVip, useVipAsSnat, uuid, vhDomainName, vhParentVsUuid, vip, vrfContextRef, vsDatascripts,
				vsvipCloudConfigCksum, vsvipRef, wafPolicyRef, weight);
	}
	...
	public String toString() {
		...
		sb.append("    closeClientConnOnConfigUpdate: ").append(toIndentedString(closeClientConnOnConfigUpdate))
				.append("\n");
		...
		sb.append("    removeListeningPortOnVsDown: ").append(toIndentedString(removeListeningPortOnVsDown))
				.append("\n");
