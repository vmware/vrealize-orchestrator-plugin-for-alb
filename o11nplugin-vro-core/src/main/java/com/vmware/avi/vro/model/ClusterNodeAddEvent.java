 ...
 *
 */
@VsoObject(create = false, name = "ClusterNodeAddEvent")
@VsoFinder(name = Constants.FINDER_VRO_CLUSTERNODEADDEVENT)
@JsonIgnoreProperties(ignoreUnknown = true)
@Service
public class ClusterNodeAddEvent extends AviRestResource {
    @JsonProperty("ip")
...
public boolean equals(java.lang.Object o) {
  ...
  Objects.equals(this.ip6, objClusterNodeAddEvent.ip6);
}
