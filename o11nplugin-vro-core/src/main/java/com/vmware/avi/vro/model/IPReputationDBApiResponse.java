...
import com.vmware.avi.vro.model.IPReputationDB;
...
@VsoObject(create = false, name = "IPReputationDBApiResponse")
@VsoFinder(name = Constants.FINDER_VRO_IPREPUTATIONDBAPIRESPONSE, idAccessor = "getObjectID()")
@Service
public class IPReputationDBApiResponse extends AviRestResource  {
  @JsonProperty("count")
  ...
  **/
  ...
  public String getObjectID() {
		return "IPReputationDBApiResponse";
  }
