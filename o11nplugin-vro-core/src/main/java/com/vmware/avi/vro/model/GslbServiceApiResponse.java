...
import com.vmware.avi.vro.model.GslbService;
...
@VsoObject(create = false, name = "GslbServiceApiResponse")
@VsoFinder(name = Constants.FINDER_VRO_GSLBSERVICEAPIRESPONSE, idAccessor = "getObjectID()")
@Service
public class GslbServiceApiResponse extends AviRestResource  {
  @JsonProperty("count")
