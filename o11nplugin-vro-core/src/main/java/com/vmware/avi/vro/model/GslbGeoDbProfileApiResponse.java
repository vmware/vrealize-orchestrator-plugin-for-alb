...
import com.vmware.avi.vro.model.GslbGeoDbProfile;
...
@VsoObject(create = false, name = "GslbGeoDbProfileApiResponse")
@VsoFinder(name = Constants.FINDER_VRO_GSLBGEODBPROFILEAPIRESPONSE, idAccessor = "getObjectID()")
@Service
public class GslbGeoDbProfileApiResponse extends AviRestResource  {
  @JsonProperty("count")
  ...
  **/
  ...
  public String getObjectID() {
		return "GslbGeoDbProfileApiResponse";
  }
