...
@VsoFinder(name = Constants.FINDER_VRO_PROPERTY, idAccessor = "getObjectID()")
@Service
public class Property extends AviRestResource  {
   ...
   * @return name
  **/
  @ApiModelProperty(required = true, value = "Property name. Field introduced in 17.2.1.")
  @NotNull
   ...
   * @return value
  **/
  @ApiModelProperty(value = "Property value. Field introduced in 17.2.1.")
