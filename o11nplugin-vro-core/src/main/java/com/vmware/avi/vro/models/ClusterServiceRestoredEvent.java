 ...
 *
 */
@VsoObject(create = false, name = "ClusterServiceRestoredEvent")
@VsoFinder(name = Constants.FINDER_VRO_CLUSTERSERVICERESTOREDEVENT)
@JsonIgnoreProperties(ignoreUnknown = true)
@Service
public class ClusterServiceRestoredEvent extends AviRestResource {
