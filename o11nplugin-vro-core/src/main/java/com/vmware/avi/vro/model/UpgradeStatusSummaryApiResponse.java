...
import com.vmware.avi.vro.model.UpgradeStatusSummary;
...
@VsoObject(create = false, name = "UpgradeStatusSummaryApiResponse")
@VsoFinder(name = Constants.FINDER_VRO_UPGRADESTATUSSUMMARYAPIRESPONSE, idAccessor = "getObjectID()")
@Service
public class UpgradeStatusSummaryApiResponse extends AviRestResource  {
  @JsonProperty("count")
  ...
  **/
  ...
  public String getObjectID() {
		return "UpgradeStatusSummaryApiResponse";
  }
