...
import com.vmware.avi.vro.model.WafPolicyPSMGroup;
...
@VsoObject(create = false, name = "WafPolicyPSMGroupApiResponse")
@VsoFinder(name = Constants.FINDER_VRO_WAFPOLICYPSMGROUPAPIRESPONSE, idAccessor = "getObjectID()")
@Service
public class WafPolicyPSMGroupApiResponse extends AviRestResource  {
  @JsonProperty("count")
  ...
  **/
  ...
  public String getObjectID() {
		return "WafPolicyPSMGroupApiResponse";
  }
