...
@VsoFinder(name = Constants.FINDER_VRO_EVENTDETAILSFILTER, idAccessor = "getObjectID()")
@Service
public class EventDetailsFilter extends AviRestResource  {
  ...
  **/
  @ApiModelProperty(required = true, value = "event_details_key of EventDetailsFilter.")
  @NotNull
  ...
  **/
  @ApiModelProperty(required = true, value = "event_details_value of EventDetailsFilter.")
  @NotNull
