 ...
 *
 */
@VsoObject(create = false, name = "SeUpgradeMigrateEventDetails")
@VsoFinder(name = Constants.FINDER_VRO_SEUPGRADEMIGRATEEVENTDETAILS)
@JsonIgnoreProperties(ignoreUnknown = true)
@Service
public class SeUpgradeMigrateEventDetails extends AviRestResource {
