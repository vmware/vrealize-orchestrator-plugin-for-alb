 ...
 *
 */
@VsoObject(create = false, name = "DebugVirtualServiceObjSync")
@VsoFinder(name = Constants.FINDER_VRO_DEBUGVIRTUALSERVICEOBJSYNC)
@JsonIgnoreProperties(ignoreUnknown = true)
@Service
public class DebugVirtualServiceObjSync extends AviRestResource {
