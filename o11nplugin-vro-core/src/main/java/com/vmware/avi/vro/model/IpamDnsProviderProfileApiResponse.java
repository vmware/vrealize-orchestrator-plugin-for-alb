...
import com.vmware.avi.vro.model.IpamDnsProviderProfile;
...
@VsoObject(create = false, name = "IpamDnsProviderProfileApiResponse")
@VsoFinder(name = Constants.FINDER_VRO_IPAMDNSPROVIDERPROFILEAPIRESPONSE, idAccessor = "getObjectID()")
@Service
public class IpamDnsProviderProfileApiResponse extends AviRestResource  {
  @JsonProperty("count")
  ...
  **/
  ...
  public String getObjectID() {
		return "IpamDnsProviderProfileApiResponse";
  }
