...
import com.vmware.avi.vro.model.AlertConfig;
...
@VsoObject(create = false, name = "AlertConfigApiResponse")
@VsoFinder(name = Constants.FINDER_VRO_ALERTCONFIGAPIRESPONSE, idAccessor = "getObjectID()")
@Service
public class AlertConfigApiResponse extends AviRestResource  {
  @JsonProperty("count")
