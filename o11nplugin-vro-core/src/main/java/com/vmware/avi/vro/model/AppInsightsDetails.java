 ...
 *
 */
@VsoObject(create = false, name = "AppInsightsDetails")
@VsoFinder(name = Constants.FINDER_VRO_APPINSIGHTSDETAILS)
@JsonIgnoreProperties(ignoreUnknown = true)
@Service
public class AppInsightsDetails extends AviRestResource {
    @JsonProperty("error")
