 ...
 *
 */
@VsoObject(create = false, name = "JournalTask")
@VsoFinder(name = Constants.FINDER_VRO_JOURNALTASK)
@JsonIgnoreProperties(ignoreUnknown = true)
@Service
public class JournalTask extends AviRestResource {
...
public boolean equals(java.lang.Object o) {
  ...
  Objects.equals(this.state, objJournalTask.state);
}
