...
import com.vmware.avi.vro.model.ServiceOAuth;
 ...
 *
 */
@VsoObject(create = false, name = "ServiceAuthProfile")
@VsoFinder(name = Constants.FINDER_VRO_SERVICEAUTHPROFILE, idAccessor = "getObjectID()")
