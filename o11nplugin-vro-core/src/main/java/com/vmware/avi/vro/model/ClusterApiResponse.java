...
import com.vmware.avi.vro.model.Cluster;
...
@VsoObject(create = false, name = "ClusterApiResponse")
@VsoFinder(name = Constants.FINDER_VRO_CLUSTERAPIRESPONSE, idAccessor = "getObjectID()")
@Service
public class ClusterApiResponse extends AviRestResource  {
  @JsonProperty("count")
