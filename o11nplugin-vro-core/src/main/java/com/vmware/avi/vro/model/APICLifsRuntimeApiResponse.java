...
import com.vmware.avi.vro.model.APICLifsRuntime;
...
@VsoObject(create = false, name = "APICLifsRuntimeApiResponse")
@VsoFinder(name = Constants.FINDER_VRO_APICLIFSRUNTIMEAPIRESPONSE, idAccessor = "getObjectID()")
@Service
public class APICLifsRuntimeApiResponse extends AviRestResource  {
  @JsonProperty("count")
  ...
  **/
  ...
  public String getObjectID() {
		return "APICLifsRuntimeApiResponse";
  }
