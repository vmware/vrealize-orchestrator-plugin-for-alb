 ...
 *
 */
@VsoObject(create = false, name = "DetachIpStatusEventDetails")
@VsoFinder(name = Constants.FINDER_VRO_DETACHIPSTATUSEVENTDETAILS)
@JsonIgnoreProperties(ignoreUnknown = true)
@Service
public class DetachIpStatusEventDetails extends AviRestResource {
    @JsonProperty("reason")
