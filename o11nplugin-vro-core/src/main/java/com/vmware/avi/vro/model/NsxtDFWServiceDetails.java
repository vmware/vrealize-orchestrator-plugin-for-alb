 ...
 *
 */
@VsoObject(create = false, name = "NsxtDFWServiceDetails")
@VsoFinder(name = Constants.FINDER_VRO_NSXTDFWSERVICEDETAILS)
@JsonIgnoreProperties(ignoreUnknown = true)
@Service
public class NsxtDFWServiceDetails extends AviRestResource {
