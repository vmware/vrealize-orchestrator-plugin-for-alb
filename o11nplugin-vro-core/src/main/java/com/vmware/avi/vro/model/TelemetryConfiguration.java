 ...
 *
 */
@VsoObject(create = false, name = "TelemetryConfiguration")
@VsoFinder(name = Constants.FINDER_VRO_TELEMETRYCONFIGURATION, idAccessor = "getObjectID()")
@JsonIgnoreProperties(ignoreUnknown = true)
@Service
public class TelemetryConfiguration extends AviRestResource {
    @JsonProperty("enable")
