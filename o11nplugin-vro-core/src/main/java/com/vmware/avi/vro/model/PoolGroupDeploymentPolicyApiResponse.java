...
import com.vmware.avi.vro.model.PoolGroupDeploymentPolicy;
...
@VsoObject(create = false, name = "PoolGroupDeploymentPolicyApiResponse")
@VsoFinder(name = Constants.FINDER_VRO_POOLGROUPDEPLOYMENTPOLICYAPIRESPONSE, idAccessor = "getObjectID()")
@Service
public class PoolGroupDeploymentPolicyApiResponse extends AviRestResource  {
  @JsonProperty("count")
  ...
  **/
  ...
  public String getObjectID() {
		return "PoolGroupDeploymentPolicyApiResponse";
  }
