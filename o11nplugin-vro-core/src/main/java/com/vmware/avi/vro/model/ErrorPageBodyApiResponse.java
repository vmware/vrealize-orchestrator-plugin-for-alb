...
import com.vmware.avi.vro.model.ErrorPageBody;
...
@VsoObject(create = false, name = "ErrorPageBodyApiResponse")
@VsoFinder(name = Constants.FINDER_VRO_ERRORPAGEBODYAPIRESPONSE, idAccessor = "getObjectID()")
@Service
public class ErrorPageBodyApiResponse extends AviRestResource  {
  @JsonProperty("count")
  ...
  **/
  ...
  public String getObjectID() {
		return "ErrorPageBodyApiResponse";
  }
