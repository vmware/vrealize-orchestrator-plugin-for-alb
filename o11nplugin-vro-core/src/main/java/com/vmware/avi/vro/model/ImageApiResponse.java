...
import com.vmware.avi.vro.model.Image;
...
@VsoObject(create = false, name = "ImageApiResponse")
@VsoFinder(name = Constants.FINDER_VRO_IMAGEAPIRESPONSE, idAccessor = "getObjectID()")
@Service
public class ImageApiResponse extends AviRestResource  {
  @JsonProperty("count")
