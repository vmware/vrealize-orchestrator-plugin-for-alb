...
public class WafLog extends AviRestResource {
    ...
    @JsonProperty("used_body_parser")
    @JsonInclude(Include.NON_NULL)
    private String usedBodyParser = "WAF_REQUEST_PARSER_DO_NOT_PARSE";
  ...
  /**
   * This is the getter method this will return the attribute value.
   * Indicate which parser was used for this request body (if any).
   ...
   * Allowed with any value in enterprise, enterprise with cloud services edition.
   * Default value when not specified in API or module is interpreted by Avi Controller as "WAF_REQUEST_PARSER_DO_NOT_PARSE".
   * @return usedBodyParser
   */
  @VsoMethod
  public String getUsedBodyParser() {
    return usedBodyParser;
  }
   ...
   * Allowed with any value in enterprise, enterprise with cloud services edition.
   * Default value when not specified in API or module is interpreted by Avi Controller as "WAF_REQUEST_PARSER_DO_NOT_PARSE".
   * @param usedBodyParser set the usedBodyParser.
   */
  @VsoMethod
  public void setUsedBodyParser(String  usedBodyParser) {
    this.usedBodyParser = usedBodyParser;
  }
...
public boolean equals(java.lang.Object o) {
  ...
  Objects.equals(this.usedBodyParser, objWafLog.usedBodyParser);
}
...
public String toString() {
  ...
  sb.append("class WafLog {\n");
      sb.append("    allowlistConfigured: ").append(toIndentedString(allowlistConfigured)).append("\n");
        ...
        sb.append("    usedBodyParser: ").append(toIndentedString(usedBodyParser)).append("\n");
      sb.append("}");
  return sb.toString();
}
