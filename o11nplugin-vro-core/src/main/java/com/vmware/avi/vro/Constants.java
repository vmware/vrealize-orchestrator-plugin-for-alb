...
public class Constants {
	...
	public static final String TYPE_POWERSHELL_HOST = String.format("%s:%s", Constants.PLUGIN_NAME,
			Constants.FINDER_AVI_VRO_CLIENT);
	public static final String TYPE_VRO_REMOTE_PS_OBJECT = String.format("%s:%s", Constants.PLUGIN_NAME,
			Constants.FINDER_VRO_REMOTE_PS_OBJECT);
}