...
@VsoFinder(name = Constants.FINDER_VRO_SECURITYMGRDEBUGFILTER, idAccessor = "getObjectID()")
@Service
public class SecurityMgrDebugFilter extends AviRestResource  {
   ...
   * @return entityRef
  **/
  @ApiModelProperty(value = "uuid of the entity. It is a reference to an object of type Virtualservice. Field introduced in 18.2.6.")
