...
import com.vmware.avi.vro.model.TestSeDatastoreLevel2;
...
@VsoObject(create = false, name = "TestSeDatastoreLevel2ApiResponse")
@VsoFinder(name = Constants.FINDER_VRO_TESTSEDATASTORELEVEL2APIRESPONSE, idAccessor = "getObjectID()")
@Service
public class TestSeDatastoreLevel2ApiResponse extends AviRestResource  {
  @JsonProperty("count")
  ...
  **/
  ...
  public String getObjectID() {
		return "TestSeDatastoreLevel2ApiResponse";
  }
