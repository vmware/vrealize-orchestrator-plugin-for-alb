...
import com.vmware.avi.vro.model.TestSeDatastoreLevel3;
...
@VsoObject(create = false, name = "TestSeDatastoreLevel3ApiResponse")
@VsoFinder(name = Constants.FINDER_VRO_TESTSEDATASTORELEVEL3APIRESPONSE, idAccessor = "getObjectID()")
@Service
public class TestSeDatastoreLevel3ApiResponse extends AviRestResource  {
  @JsonProperty("count")
  ...
  **/
  ...
  public String getObjectID() {
		return "TestSeDatastoreLevel3ApiResponse";
  }
